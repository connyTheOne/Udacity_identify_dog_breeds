...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            if line in dog_dic:
                print("Warning: Duplicate dog name found:", line)
            else:
                dog_dic[line] = 1
    ...
    for key in results_dic:
        ...
        # Pet Image Label IS NOT a Dog image (e.g. NOT found in dognames_dic)
            ...
            # Classifier Label IS image of Dog (e.g. found in dognames_dic) appends (0, 1)because only Classifier labe is a dog
            results_dic[key].extend([0, 1])
                            
        # Classifier Label IS NOT image of Dog (e.g. NOT in dognames_dic) appends (0, 0) because both labels aren't dogs
        elif results_dic[key][0] not in dog_dic and results_dic[key][1] not in dog_dic:
